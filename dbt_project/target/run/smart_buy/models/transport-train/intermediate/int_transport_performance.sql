  ...
  create  table "smart_buy_db"."public_transport"."int_transport_performance__dbt_tmp"
  
  
    as
  
  (
    WITH delays AS (SELECT * FROM "smart_buy_db"."public_transport"."stg_sncf_regularite"),
freq AS (SELECT * FROM "smart_buy_db"."public_transport"."stg_sncf_frequentation")
